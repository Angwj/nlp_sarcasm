...
from featExtractor2 import FeatureExtractor
...
def predict(pred_model, text, audio, visual, text_c, audio_c, visual_c):
        with torch.no_grad():
            ...
            prediction = pred_model(text, audio, visual, text_c, audio_c, visual_c)
...
def main():
    ...
    if st.button("Predict"):
        if input_data:
            ...
            is_sarcastic, prob = predict(pred_model, T_u, A_u, V_u, T_c, A_c, V_c)
